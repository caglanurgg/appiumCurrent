...
public class Driver {
    ...
    public static AndroidDriver getAndroidDriver()  {
        ...
        if (appiumDriver == null) {
            ...
            caps.setCapability("appPackage",ConfigReader.getProperty("com.skypicker.main"));
            caps.setCapability("appActivity",ConfigReader.getProperty("com.kiwi.android.feature.splash.impl.ui.SplashActivity"));
